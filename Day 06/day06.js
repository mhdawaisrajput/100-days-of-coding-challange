...
*/
console.log("Unfortunately, Our new table won't arrive in time for the dinner. So we have only two peple space for dinner!");
let unableToAttend = ["Asad", "Shahid", "Junaid", "Awais"];
unableToAttend.forEach((unableToAttend) => {
    console.log(`Sorry Mr.${unableToAttend}, You are unable to attend the dinner`);
});
let newGuest = ["Saif", "Shoaib"];
...
console.log("Reverse Alphabetical order:", [...locationsToVisist].sort().reverse());
// original order
console.log("Original order:", locationsToVisist);
